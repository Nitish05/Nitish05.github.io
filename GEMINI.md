...
*   **Jarallax:** For parallax scrolling effects.
...
This is a static website, so there is no build process required. To run the website, you can simply open the `index.html` file in a web browser.

# Development Conventions

The project follows standard web development practices. The code is well-structured and easy to read.

*   **HTML:** The HTML is semantic and uses proper tags.
